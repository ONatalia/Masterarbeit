...
{@link org.cocolab.inpro.incremental.processor.CurrentASRHypothesis},
...
state) to a set of {@link org.cocolab.inpro.incremental.unit.IU}
objects (words, syllables and segments) and 
{@link org.cocolab.inpro.incremental.unit.EditMessage}s 
...
in {@link org.cocolab.inpro.incremental.deltifier.ASRWordDeltifier} 
(which additionally export operations such
as resetting and configuration (using Sphinx' configuration management).
<p>
The interface {@link org.cocolab.inpro.incremental.deltifier.ASRResultKeeper} 
...
{@link org.cocolab.inpro.incremental.deltifier.ASRWordDeltifier}.
<p>
The following deltifiers are provided:
<dl>
<dt>{@link org.cocolab.inpro.incremental.deltifier.ASRWordDeltifier}</dt>
...
<dt>{@link org.cocolab.inpro.incremental.deltifier.SmoothingDeltifier}</dt>
<dd>
...
<dt>{@link org.cocolab.inpro.incremental.deltifier.NonIncrementalDeltifier}</dt>
