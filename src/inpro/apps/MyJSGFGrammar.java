 ...
 * </ol>
 */
public class MyJSGFGrammar extends Grammar {
    ...
    public MyJSGFGrammar(String location, LogMath logMath, String grammarName,
    ...
    public MyJSGFGrammar(URL baseURL, LogMath logMath, String grammarName,
            boolean showGrammar, boolean optimizeGrammar,
            boolean addSilenceWords, boolean addFillerWords,
    ...
    public void commitChanges() throws IOException, JSGFGrammarParseException,
		...
		finalNode = createGrammarNode("<sil>");
    ...
    private void loadImports(JSGFRuleGrammar grammar) throws IOException,
        ...
        for (JSGFRuleName ruleName : grammar.getImports()) {
