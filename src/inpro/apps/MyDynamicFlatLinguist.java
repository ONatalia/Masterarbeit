...
public class MyDynamicFlatLinguist implements Linguist, Configurable {
    ...
    public MyDynamicFlatLinguist(AcousticModel acousticModel, Grammar grammar, UnitManager unitManager, LogMath logMath,
